...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-[#FBF7F2]">
      ...
      <div className="relative mx-auto flex min-h-[90vh] max-w-7xl flex-col items-center px-6 py-16 lg:flex-row lg:gap-16">
        ...
        <div className="relative mt-16 flex-1 lg:mt-0">
          ...
          <div className="absolute -left-8 bottom-10 hidden rounded-2xl bg-white p-5 shadow-xl lg:block">

            <p className="text-xs uppercase tracking-[4px] text-gray-400">
              NEW COLLECTION
            </p>

            <h3 className="mt-2 text-xl font-semibold text-[#3D2A22]">
              Spring Blossom
            </h3>

            <p className="mt-2 text-sm text-gray-500">
              Inspired by nature's first bloom.
            </p>
